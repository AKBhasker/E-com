  ...
  return (
    ...
    <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0">
        <div className="px-6">
            ...
            <form className="flex">
                ...
                <button type="submit" className="bg-black text-white px-6 py-3 text-sm rounded-r-md hover:bg-gray-800 transition-all">Suscribe</button>
            </form> 
        </div>
        {/* shop Links */}
        <div className="px-6" >
    ...
    <div className="container mx-auto mt-12 px-4 lg:px-0 border-t border-gray-200 pt-6">
        <p className="text-gray-500 text-sm text-center tracking-tighter">
            @2025,    DigiwebTitan    All    Right    Reserved.
        </p>
    </div>
