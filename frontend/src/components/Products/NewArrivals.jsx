  ...
  return (
   <section className="py-16 px-4 lg:px-0">
    <div className="container mx-auto text-center mb-10 relative">
       <h2 className="text-3xl font-bold mb-4"> Expolre New Arrivals</h2>
    ...
    <div ref={scrollRef}
     ...
     >
        {newArrivals.map((product)=>( 
            ...
            <div key={product._id} className="min-w-[100%] sm:min-[50%] lg:min-w-[30%] relative ">
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-orange-50 backdrop-blur-md text-white rounded-b-lg">
